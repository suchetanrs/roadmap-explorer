#include <roadmap_explorer/costmap_tools.hpp>
...
FrontierSearchAllCells::FrontierSearchAllCells(
...
std::vector<FrontierPtr> FrontierSearchAllCells::buildNewFrontier(
...
bool FrontierSearchAllCells::isNewFrontierCell(
  unsigned int idx,
